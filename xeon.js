...
Ketik *-menu* Untuk melihat semua list menu Miuna Bot
Dan jika berkenan , Bantu bot tetap hidup dengan cara ketik *-donasi*
Terima Kasih
`
XeonBotInc.sendMessage(anu.id, {text : mikutext, mentions : [num]})
